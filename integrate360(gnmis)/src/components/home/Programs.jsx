            ...
            <div className="relative z-10">
                ...
                <div className="bg-[#d94740] pt-12 pb-16">
                    <div className="flex flex-wrap justify-center gap-6 -mt-32">
                        <div className="bg-white rounded-lg shadow-md p-4 w-full max-w-[280px] hover:shadow-lg transition-shadow duration-300">
                        ...
                        {programs.slice(1).map((program, index) => (
                            <div
                                key={index}
                                className="bg-white rounded-lg shadow-md p-4 w-full max-w-[280px] text-center hover:shadow-lg transition-shadow duration-300"
                            >
                                <div className="flex justify-center space-y-6 mb-3">
                                    <img src={program.icon} alt={program.title} className="h-10 w-10" />
                                </div>
                                <h3 className="text-xl font-bold space-y-6 text-[#0e3c60] mb-2 text-center">
                                    {program.title}
                                    <span className="block mx-auto mt-1 w-20 h-[1.5px] bg-[#0e3c60] relative">
                                        <span className="absolute w-4 h-[1.5px] bg-red-500 right-0 top-0"></span>
                                    </span>
                                </h3>
